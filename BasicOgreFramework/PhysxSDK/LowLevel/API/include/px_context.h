...
PXD_EXPORT_FUNCTION PxdContext PxdContextCreate(PxdContextType type, void* agPPUConnection, PxdBroadPhaseImplementation bp, bool useFastMassiveBPVolumeDeletion, bool useImprovedSpringSolver);
#else
